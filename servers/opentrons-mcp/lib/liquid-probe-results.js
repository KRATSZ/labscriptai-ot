...
export async function applyLiquidProbeResults(args, { recordLiquidSourceMap, summarizeLiquidSourceMap } = {}) {
  if (typeof recordLiquidSourceMap !== "function") {
    throw new Error("applyLiquidProbeResults requires recordLiquidSourceMap.");
  }
  ...
  const recordResult = await recordLiquidSourceMap({
  ...
  return {
    data: {
      ...
      record_result: recordResult.data,
